    ...
    class ListIdea extends FetchAbstract {
        ...
        statusInformation(st) {
            switch (st) {
                case 0:
                    return {
                        border: 'rgb(255, 209, 102)',
                        back: 'rgba(255, 209, 102, 0.2)',
                        status: 'Oczekuje',
                    };
                case 1:
                    return {
                        border: 'rgb(6, 214, 160)',
                        back: 'rgba(6, 214, 160, 0.2)',
                        status: 'Zakceptowany',
                    };
                case 2:
                    return {
                        border: 'rgb(17, 138, 178)',
                        back: 'rgb(17, 138, 178, 0.2)',
                        status: 'Wdrożony',
                    };
                case 3:
                    return {
                        border: 'rgb(239, 71, 111)',
                        back: 'rgba(239, 71, 111, 0.2)',
                        status: 'Odrzucony',
                    };
                case 4:
                    return {
                        border: 'rgb(7, 59, 76)',
                        back: 'rgb(7, 59, 76, 0.1)',
                        status: 'Kopia',
                    };
                default:
                    return {
